...
class Entropy(object):
    ...
    def get_bits_of_info(self, attributes, signature, signature_mobile):
        ...
        result = [cookie_boi, user_agent_boi, http_accept_boi, dnt_boi, plugins_boi, video_boi, timezone_boi, language_boi, platform_boi, touch_support_boi, fonts_boi, supercookies_boi, canvas_hash_boi, webgl_hash_boi, timezone_string_boi, webgl_v_boi, cpu_class_boi, hardware_concurrency_boi, activity_boi, loads_remote_boi]
